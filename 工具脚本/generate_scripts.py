...
### ⚠️ 呆毛安全铁律（v4.8新增）
- 🚫 **呆毛绝不能当工具**：禁止呆毛伸长/拉长去勾取、拖拽、缠绕物品。脚本006实测呆毛弯成钩子勾碗→Seedance 2.0产生异常拉长变形bug。
- 🚫 禁止呆毛长度超过半头高、分叉过多呈蒲公英状、顶端"开出小花""爆炸成烟花"
- ✅ 呆毛仅5种允许状态：竖立（警觉）、软塌（委屈）、弹跳（兴奋）、缓慢转圈（满足）、微弯（好奇，≤30°弧度）
- ✅ 够不到东西 → 用跳跃/踮脚/推椅子。不要用呆毛。
